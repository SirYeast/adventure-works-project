...
namespace adventure_works_project.Migrations
{
    ...
    [Migration("20230328161048_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("adventure_works_project.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("adventure_works_project.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("adventure_works_project.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("adventure_works_project.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("adventure_works_project.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("adventure_works_project.Models.CustomerAddress", b =>
                {
                    b.HasOne("adventure_works_project.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("adventure_works_project.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("adventure_works_project.Models.Product", b =>
                {
                    b.HasOne("adventure_works_project.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("adventure_works_project.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductCategory", b =>
                {
                    b.HasOne("adventure_works_project.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("adventure_works_project.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("adventure_works_project.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("adventure_works_project.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("adventure_works_project.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("adventure_works_project.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("adventure_works_project.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("adventure_works_project.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("adventure_works_project.Models.Address", "ShipToAddress")
